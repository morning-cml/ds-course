...
/* 假 SVG、沙箱垫片与 loadViz() 都收在 lib-viz.mjs 里 —— 与 vz-check、verify-stats 共用同一份，
   避免「三处各写一遍、改一处漏两处」。理由与踩过的坑见那个文件的头部注释。 */
import { ROOT, JS_DIR, SVG, renderAll, textsOf, loadViz } from "./lib-viz.mjs";
